...
</script><form name="formAdd" method="post" action="productupdate" class="form-horizontal" role="form">
...
<div class="form-group">
    <label class="col-sm-2 control-label" for="number">编号</label>
      <div class="col-sm-4">
<input name="number" type="text" id="number" class="form-control"  value="${c.number}" >
 </div>
	</div>
...
<div class="form-group">
    <label class="col-sm-2 control-label" for="price">价格</label>
      <div class="col-sm-4">
<input name="price" type="text" id="price" class="form-control"  value="${c.price}" >
 </div>
	</div>
<div class="form-group">
...
<div class="form-group">
    <label class="col-sm-2 control-label" for="remarks">备注</label>
      <div class="col-sm-4">
<input name="remarks" type="text" id="remarks" class="form-control"  value="${c.remarks}" >
 </div>
	</div>
