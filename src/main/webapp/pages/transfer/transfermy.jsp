...
<table class="table table-hover">
    <tr>
        <th>
            <form name="formsea" class="form-inline" role="form" method="post" action="<%=path %>/transfermy">
        ...
        <tbody><tr>
            ...
            <td>
                <c:if test="${c.state=='未审核'}">
                    <a href="<%=path %>/transferedit?id=${c.id}&forword=transfermy" class="btn btn-default">修改</a> |
                    <a href="transferdel?id=${c.id}&forword=transfermy" onClick="return confirm('您确定要删除吗?')" class="btn btn-default">删除</a>
                </c:if>
            </td>
        </tr></tbody>
    </c:forEach>
...
<script type="text/javascript">
    function go(index) {
        window.location.href="<%=path %>/transfermy?index="+index;
    }
</script>
