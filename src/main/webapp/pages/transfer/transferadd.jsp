...
<div class="container">
    ...
    <form name="formAdd" method="post" action="<%=path %>/transferinsert" class="form-horizontal" role="form">
        <fieldset>
            <legend>添加门店调货</legend>
        ...
        <fieldset>
            ...
            <div class="form-group">
                <div class="col-sm-10 col-sm-offset-2">
                    <input name="forword" type="hidden" value="transfermy"/>
