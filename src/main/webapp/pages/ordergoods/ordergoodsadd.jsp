...
<div class="container">
    ...
    <form name="formAdd" method="post" action="<%=path %>/ordergoodsinsert" class="form-horizontal" role="form">
        <fieldset> <legend>添加门店订货</legend>	
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label" for="nums">数量</label>
                <div class="col-sm-4">
        ...
        <fieldset>
            ...
            <div class="form-group">
                <div class="col-sm-10 col-sm-offset-2">
                    <input name="forword" type="hidden" value="ordergoodsmy"/>
