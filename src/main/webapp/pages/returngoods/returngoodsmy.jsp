...
<table class="table table-hover">
    <tr>
        <th>
            <form name="formsea" class="form-inline" role="form" method="post" action="<%=path %>/returngoodsmy">
        ...
        <tr>
            ...
            <td>
                <c:if test="${c.state=='未审核'}">
                    <a href="<%=path %>/returngoodsedit?id=${c.id}&forword=returngoodsmy" class="btn btn-default">修改</a> |
                    <a href="returngoodsdel?id=${c.id}&forword=returngoodsmy" onClick="return confirm('您确定要删除吗?')" class="btn btn-default">删除</a>
                </c:if>
            </td>
        </tr>
        </tbody>
...
<script type="text/javascript">
    function go(index) {
        window.location.href="<%=path %>/returngoodsmy?index="+index;
    }
</script>
