...
<div class="container">
    ...
    <form name="formAdd" method="post" action="<%=path %>/returngoodsupdate" class="form-horizontal" role="form">
        <fieldset>
            <legend>审核</legend>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4" id="state">
                    <label><input type="radio" name="state" value="通过" checked> 通过 </label>
                    <label><input type="radio" name="state" value="拒绝">拒绝</label>
                </div>
            </div>
