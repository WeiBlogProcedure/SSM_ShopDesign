...
<form name="formAdd" method="post" action="<%=path %>/adminreg" class="form-horizontal" role="form">
	<fieldset> <legend>用户注册</legend>	

<div class="form-group">
             <label class="col-sm-2 control-label" for="adminname">管理员账号</label>
              <div class="col-sm-4">
<input name="adminname" type="text" id="adminname" class="form-control" placeholder="" >
     ...
     <legend></legend>
		<div class="form-group">
            <div class="col-sm-10 col-sm-offset-2">
			       <input name="forword" type="hidden" value="index?msg=1"/>
