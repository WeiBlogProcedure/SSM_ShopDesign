...
<table   class="table table-hover">
 <tr> <th>
<form name="formsea" class="form-inline" role="form" method="post" action="<%=path %>/adminlist">
  
  <div class="form-group">
    <div class="col-sm-2">
	<input type="text" name="adminname" id="adminname" class="form-control" placeholder="管理员账号"/>
	</div>
  </div>
...
<td>${c.pwd}</td>
	       ...
	       function go(index)
           {
               window.location.href="<%=path %>/adminAll?index="+index;
           }
</script>
<table class="table table-hover table-striped table-bordered">
						        <tr>
