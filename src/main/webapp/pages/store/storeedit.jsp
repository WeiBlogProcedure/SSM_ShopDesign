...
</script><form name="formAdd" method="post" action="storeupdate" class="form-horizontal" role="form">
<fieldset> <legend>修改门店</legend>
...
<div class="form-group">
    <label class="col-sm-2 control-label" for="address">门店地址</label>
      <div class="col-sm-4">
<input name="address" type="text" id="address" class="form-control"  value="${c.address}" >
 </div>
	</div>
...
<div class="form-group">
    <label class="col-sm-2 control-label" for="tname">店长姓名</label>
      <div class="col-sm-4">
<input name="tname" type="text" id="tname" class="form-control"  value="${c.tname}" >
 </div>
	</div>
