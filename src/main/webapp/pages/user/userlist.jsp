...
<table   class="table table-hover">
 <tr> <th>
<form name="formsea" class="form-inline" role="form" method="post" action="<%=path %>/userlist">
  ...
  <div class="form-group">
    <div class="col-sm-2">
	<input type="text" name="position" id="position" class="form-control" placeholder="职位"/>
	</div>
  </div>
  ...
  <div class="form-group">
    <div class="col-sm-2">
	<input type="text" name="limits" id="limits" class="form-control" placeholder="权限"/>
	</div>
  </div>
...
<table class="table table-hover table-striped table-bordered">
 <tr><th>员工列表 &nbsp; &nbsp;
 <!--
 <button type="button" onclick="location.href='<%=path %>/useradd'" class="btn  btn-primary">添加</button>
 -->
</th></tr></table>
<table class="table table-hover table-striped table-bordered">
 <thead>
...
<td> 
 <a href="<%=path %>/useredit?id=${c.id}&forword=userlist" class="btn btn-default">修改</a> |
 <a href="userdel?id=${c.id}&forword=userlist" onClick="return confirm('您确定要删除吗?')" class="btn btn-default">删除</a>
 </td>
</tr></tbody>
</c:forEach> </table><script type="text/javascript">
	       function go(index)
           {
               window.location.href="<%=path %>/userlist?index="+index;
           }
</script>
<table class="table table-hover table-striped table-bordered">
						        <tr>
