...
public class ReturnGoods {
	...
	private Sort sortfk;//用于获得产品信息
	private Integer store;//门店
	private Store storefk;//用于获得门店信息
	private Integer nums;//退货数量
	private String sdate;//日期
	private String state;//状态
	private String uname;//用户名（执行此操作的员工）
	...
	public String toString() {
		return "Tuihuo [id=" + id + ", name=" + name + ", sort=" + sort +
				", store=" + store + ", nums=" + nums + ", sdate=" + sdate +
